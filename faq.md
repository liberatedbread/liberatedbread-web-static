...
See the [device catalogue](/devices/) for currently-documented devices. The [Home Assistant integration](/ha-plugins/) ships with **58 protocol specs** covering sensors, switches, lights, climate devices, e-bikes, printers, and more.
